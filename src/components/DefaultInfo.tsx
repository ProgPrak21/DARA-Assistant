    ...
    return (
        <>
            <Grid item xs={12}>
                ...
                You can send a email based request via <a className="App-link" href="https://www.mydatadoneright.eu/cy/request/type">My Data Done Right</a>.
                </p>
                <p>
                ...
                at <a className="App-link" href="https://github.com/">Github</a>.
                </p>
            </Grid>
        </>
    );
